...
<body>
    <img class="vegas-background" src="http://hireable-lashes.000webhostapp.com/admin/data/img/gallery/Bg/fundo-radio.jpg" style="position: fixed; inset: -374.492px auto auto 0px; width: 1706px; height: 1473.98px;">
<!--=================================
  Header
  =================================-->
<header>
          ...
          <div class="row">
            ...
            ?>       	
                ...
                <div class="row">
        			...
        			<a href="videos"><h2>Mais Vídeos</h2></a>
                ...
                <div class="row">
              	...
              	</div><div class="news-feed text-center"><a href="noticias"><h2>Mais Notícias</h2></a></div>
...
echo "<center><a href='mural'><button type='button' class='btn btn-primary'>Deixe seu recado</button></a></center>";
 }
?>
